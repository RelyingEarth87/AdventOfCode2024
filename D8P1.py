    ...
    for i in range(len(frequencies)):
        ...
        for j in range(len(positions) - 1):
            for k in range(1, len(positions)):
                ...
                if gridx > new_point1[0] >= 0 and gridy > new_point1[1] >= 0 and new_point1 not in positions:
                    antinodes.append(new_point1)
                if gridx > new_point2[0] >= 0 and gridy > new_point2[1] >= 0 and new_point1 not in positions:
